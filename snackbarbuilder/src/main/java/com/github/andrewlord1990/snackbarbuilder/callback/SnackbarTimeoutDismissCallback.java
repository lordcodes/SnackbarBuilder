...
/**
 * A callback to be notified when the {@link Snackbar} is dismissed due to a timeout. The occurs
 * when the specified duration (when the {@link Snackbar} is created) has passed, from when the
 * {@link Snackbar} was shown.
 */
